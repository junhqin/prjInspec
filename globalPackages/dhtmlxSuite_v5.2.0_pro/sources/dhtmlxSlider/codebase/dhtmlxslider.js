...
dhtmlXSlider.prototype.setValue = function(value, callEvent) {
	...
	if (typeof(this._attachedNode.setValue) == "function") {
		...
		if (typeof index === "undefined" && value instanceof Array){
			this._attachedNode.setValue(this.conf.value, this.conf.decimals,(index||0));
			this._attachedNode.setValue(this.conf.value, this.conf.decimals, (index||0)+1);
		}
		else
			this._attachedNode.setValue(this.conf.value, this.conf.decimals, index);
	}
